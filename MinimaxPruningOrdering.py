...
def min_value(row_state, col_state, board_status, already_scored, is_score, alpha, beta, depth):
    ...
    if terminal(row_state, col_state, board_status) or depth == 0:
        return utility(board_status, is_score, player_turn)
...
def utility(board_status, is_score, player_turn):
    ...
    if is_score:
        ...
        game_score += np.count_nonzero(board_status == 3) * 100 * multiplier
